...
public class GraduateExportService {
    ...
    public List<GraduateRow> computeGraduates(Track track, int enrollmentYear){
        List<Student> students =
                studentMapper.toModel(studentRepository.findByTrackAndEnrollmentYear(track, enrollmentYear));
        List<Course> curriculum = courseMapper.toModel(courseRepository.findByTrackIsNullOrTrack(track));
