...
public class GradeService {
    ...
    public List<GradeHistory> getHistory(UUID gradeId) {
        return gradeHistoryMapper.toModel(gradeHistoryRepository.findByGradeIdOrderByModifiedAtDesc(gradeId));
    }
    ...
    public Grade setGrade(
        ...
        if (existing.isPresent() && (reason == null || reason.isBlank())) {
            throw new BadRequestException(
                    "Une raison est obligatoire pour modifier une note existante");
        }
